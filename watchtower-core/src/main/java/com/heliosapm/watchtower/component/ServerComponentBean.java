...
public abstract class ServerComponentBean extends ServerComponent implements 
	...
	public void setBeanName(String name) {
		beanName = name;
		log = getLogger(getClass().getName() + "." + beanName);
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.watchtower.component.ApplicationContextLifecycleListener#onApplicationContextStart(org.springframework.context.event.ContextStartedEvent)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.watchtower.component.ApplicationContextLifecycleListener#onApplicationContextRefresh(org.springframework.context.event.ContextRefreshedEvent)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.watchtower.component.ApplicationContextLifecycleListener#onApplicationContextStop(org.springframework.context.event.ContextStoppedEvent)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see com.heliosapm.watchtower.component.ApplicationContextLifecycleListener#onApplicationContextClose(org.springframework.context.event.ContextClosedEvent)
	 */
	@Override
